...
? - Considered in api design but not implemented

| Node               | Artist     | RobotModel | Traj Gen. | Logger | Node Lang. |
| ------------------ | ---------- | ---------- | --------- | ------ | ---------- |
| dora-rs *          | Viser      | Pinnochio  | Ruckig    |        | Python     |
| Ros 2 (red)        | Meshcat    |            | Toppra    |        | CPP        |
| Ark Robotics (red) | Open3D     |            |           |        |            |
|                    | Foxglove   |            |           |        |            |
|                    | Matplotlib |            |           |        |            |
|                    |            |            |           |        |            |

- select Backends
- Artist - [Foxglove, Viser, Meshcat, Open3d, Matplotlib]
- Transport - [Dora, Ros2]
- RobotModel - [Pinnochio] ?
- TrajGen - [Ruckig/RuckigPro]
- Logger - [Foxglove, Python, ]
- Data Storage - [Influxdb, etc.]
- Focus on the parts of the system, their connections first, the types of databeing passed 
- Things like speed, location of computation (processes and physical hardware), how messages are passed, can come later
- 4C's or seperation of concern between computation.
- Compile with AI to any other language of your choice. Simple test script to verify inputs/outputs match...
...
1. Pythonic like development, High performance static graphs for deployment
