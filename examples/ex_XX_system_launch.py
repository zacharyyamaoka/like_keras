...
# =============================================================================
def generate_system_functional_simple(
    system_config: Optional[System.Config] = None,
) -> System:
    """
...
def generate_system_explicit_config() -> System:
    ...
    my_favorite_system_config = System.Config(
        name="my_system", rate_hz=100.0, verbose=True
    )
...
def generate_system_recommended() -> System:
    ...
    return AgentEnvSystem(
        config=MyFavoriteSystemConfig(name="recommended_system", verbose=True)
    )
