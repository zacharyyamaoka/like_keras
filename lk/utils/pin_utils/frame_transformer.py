...
class FrameTransformer:
    ...
    def __init__(
        self, pin_model: PinRobotModel, cache_transforms: dict[str, str] = None
    ):
    ...
    def transform_vectorized(
        ...
        """
        assert (
            T_input.ndim == 3 and T_input.shape[1] == 4 and T_input.shape[2] == 4
    ...
    def _get_transform(
        self, from_link: str, to_link: str, cache: bool = True
    ) -> np.ndarray:
        """
