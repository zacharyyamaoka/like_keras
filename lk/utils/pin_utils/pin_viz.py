...
class PinViz:
    ...
    def from_robot_description(
        cls,
        rd: "RobotDescription",
        backend: Literal["viser", "meshcat"] = "viser",
        **kwargs,
    ):
    ...
    @classmethod
    def from_urdf_xml(
        cls, urdf_xml: str, backend: Literal["viser", "meshcat"] = "viser", **kwargs
    ):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.disabled = os.environ.get("DISABLE_PIN_VIZ", "").lower() in (
            "1",
            "true",
            "yes",
        )
    ...
    def play(self, q_trajectory, dt=None, callback=None, capture=False, **kwargs):
        ...
        return self.backend.viz.play(
            q_trajectory, dt=dt, callback=callback, capture=capture, **kwargs
        )
