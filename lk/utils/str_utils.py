...
if __name__ == "__main__":
    ...
    print("get_file_name_hash('my_config_file', 12):", get_file_name_hash('my_config_file', 12))
    print("get_file_name_hash('my_config_file', 8):", get_file_name_hash('my_config_file', 8))
    
    print("\nCase conversion:")
    print("camel_to_snake('MyROSAPI'):", camel_to_snake('MyROSAPI'))
    print("camel_to_snake('GenericActionClient'):", camel_to_snake('GenericActionClient'))
    print("camel_to_snake('BAMNode'):", camel_to_snake('BAMNode'))
    
    print("\nPath utilities:")
    print("node_name_from_file('/path/to/my_node.py'):", node_name_from_file('/path/to/my_node.py'))
    print("node_name_from_file('/path/to/test_node.py'):", node_name_from_file('/path/to/test_node.py'))
