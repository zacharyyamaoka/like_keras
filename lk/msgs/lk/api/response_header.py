...
class ResponseHeader:
    ...
    @classmethod
    def create_custom(cls, error_code: ErrorCode, error_msg: str = "", **kwargs) -> "ResponseHeader":
        """Create a response header with custom error code."""
        return cls(error_code=error_code, error_msg=error_msg, **kwargs)
    
    @classmethod
    def from_request(cls, request_header, error_code: ErrorCode = ErrorCode.SUCCESS, error_msg: str = "") -> "ResponseHeader":
