...
class JointImpedance:
    ...
    kp_scale: list[float] = field(default_factory=list)  # per-joint position stiffness (kp) scaling factors
    kd_scale: list[float] = field(default_factory=list)  # per-joint damping (kd) scaling factors
