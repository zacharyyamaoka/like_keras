...
# BAM
from bam.msgs.msg_utils import lerp_value
...
class HandParams:
    ...
    width: float = 0.0
    joint_angles: list[float] = field(default_factory=list) # helpful to carry this information along
    ...
    def difference(self, target: 'HandParams') -> dict[str, float]:
        ...
        return {'width': width_diff, 'max_effort': max_effort_diff, 'max_vel': max_vel_diff}
