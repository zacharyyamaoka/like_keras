...
class JointLimits:
    ...
    def extend(self, other: 'JointLimits') -> 'JointLimits':
        ...
        """
        def _concat(a: list[float] | None, b: list[float] | None, field_name: str) -> list[float] | None:
        ...
        return JointLimits(
            ...
            max_acceleration=_concat(self.max_acceleration, other.max_acceleration, 'max_acceleration'),
            ...
            min_acceleration=_concat(self.min_acceleration, other.min_acceleration, 'min_acceleration'),
