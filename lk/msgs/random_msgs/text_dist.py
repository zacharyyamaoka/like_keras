...
class TextDist(DataDist):
    ...
    def discrete(cls, texts: list[str]) -> 'TextDist':
        ...
        """
        return cls(
            sample_fn=lambda rng: rng.choice(texts),
            min_val=texts,
            max_val=texts
        )
    ...
    @classmethod
    def random_alphabetic(cls, min_len: int = 1, max_len: int = 10, 
                         lowercase: bool = True, uppercase: bool = True) -> 'TextDist':
    ...
    @classmethod
    def template(cls, template: str, variables: dict[str, 'TextDist | list[str]']) -> 'TextDist':
    ...
    @classmethod
    def custom(cls, sample_fn: Callable[[np.random.Generator], str],
              possible_values: Optional[list[str]] = None) -> 'TextDist':
        ...
        return cls(
            sample_fn=sample_fn,
            min_val=possible_values,
            max_val=possible_values
        )
...
if __name__ == '__main__':
    ...
    td_alpha = TextDist.random_alphabetic(3, 6, lowercase=True, uppercase=False).with_seed(42)
