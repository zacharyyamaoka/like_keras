...
class DataDist(ABC):
    ...
    def to_config(self) -> dict[str, Any]:
        ...
        """
        raise NotImplementedError(f"{self.__class__.__name__} does not support to_config")
    ...
    def permute(self) -> tuple[Any, bool]:
        ...
        """
        raise NotImplementedError(f"{self.__class__.__name__} does not support permutation")
    ...
    def permutation_total(self) -> int:
        ...
        Raises:
            NotImplementedError: If this distribution doesn't support permutation
        """
        raise NotImplementedError(f"{self.__class__.__name__} does not have discrete permutations")
