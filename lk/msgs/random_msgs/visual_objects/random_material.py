...
class RandomMaterial(RandomType):
    ...
    @classmethod
    def fixed(cls, rgba: list[float], metallic: float = 0.0, roughness: float = 1.0) -> 'RandomMaterial':
    ...
    @classmethod
    def from_rgba(cls, rgba: RGBA, metallic: float = 0.0, roughness: float = 1.0) -> 'RandomMaterial':
    ...
    @classmethod
    def grey(cls, s: float = 0.5, metallic: float = 0.0, roughness: float = 1.0) -> 'RandomMaterial':
    ...
    @classmethod
    def uniform(cls,
                rgba_lower: list[float], rgba_upper: list[float],
                metallic_lower: float = 0.0, metallic_upper: float = 1.0,
                roughness_lower: float = 0.0, roughness_upper: float = 1.0) -> 'RandomMaterial':
...
if __name__ == '__main__':
    ...
    print(f"Red: rgba={mat.color.to_tuple()}, metallic={mat.metallic}, roughness={mat.roughness}")
    ...
    # Fixed from list
    mat = RandomMaterial.fixed([1.0, 0.5, 0.0, 1.0], metallic=0.3, roughness=0.7).sample()
    print(f"From list: rgba={mat.color.to_tuple()}, metallic={mat.metallic}, roughness={mat.roughness}")
