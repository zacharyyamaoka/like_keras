...
class Grid(VisualObject):
    ...
    cell_color: RGBA = field(default_factory=lambda: RGBA(r=0.784, g=0.784, b=0.784, a=1.0))
    cell_thickness: float = 1.0
    cell_size: float = 0.5
    
    section_color: RGBA = field(default_factory=lambda: RGBA(r=0.549, g=0.549, b=0.549, a=1.0))
