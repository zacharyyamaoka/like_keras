...
class ParallelGripper(CompoundVisualObject):
    ...
    def build_model(self):
        ...
        T_gripper_finger_r = xyzrpy_to_matrix(
            [
                self.grasp_width / 2 + self.thickness / 2,
                0,
                z_dir * self.finger_height / 2,
            ],
            [0, 0, 0],
        )
        ...
        T_gripper_palm = xyzrpy_to_matrix(
            [0, 0, z_dir * (self.finger_height + self.palm_thickness / 2)], [0, 0, 0]
        )
        ...
        T_gripper_wrist = xyzrpy_to_matrix(
            [
                0,
                0,
                z_dir * (self.finger_height + self.palm_thickness + wrist_height / 2),
            ],
            [0, 0, 0],
        )
