...
if __name__ == "__main__":
    ...
    print(f"Dense: Created {len(dense_arrows.children)} arrow children from {len(R_dense)} rotations")
    ...
    print(f"Dense (unique): Created {len(dense_arrows_unique.children)} arrow children from {len(R_dense)} rotations")
