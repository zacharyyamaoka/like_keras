...
from lk.msgs.diagnostics import (
    ComponentStateMsg,
    DiagnosticStatus,
    ComponentState,
    DiagnosticLevel,
...
class DiagnosticsMixin:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.state_port = OutputPort(
            name="state", msg_type=ComponentStateMsg, owner=self
        )
        self.diagnostics_port = OutputPort(
            name="diagnostics", msg_type=DiagnosticStatus, owner=self
        )
    ...
    def set_diagnostic_error(self, message: str, hardware_id: Optional[str] = None):
        ...
        self._update_diagnostics(
            level=DiagnosticLevel.ERROR, message=message, hardware_id=hardware_id
        )

    def set_diagnostic_warn(self, message: str, hardware_id: Optional[str] = None):
        """Set diagnostic to warning level."""
        self._update_diagnostics(
            level=DiagnosticLevel.WARN, message=message, hardware_id=hardware_id
        )

    def set_diagnostic_ok(self, message: str = ""):
        """Set diagnostic to OK level."""
        self._update_diagnostics(level=DiagnosticLevel.OK, message=message)
