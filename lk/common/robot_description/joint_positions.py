...
class JointPositions:
    ...
    def get(
        self, name: str, fill_missing: Literal["default", "none", "error"] = "default"
    ...
    def _get_composite(
        self, name: str, fill_missing: Literal["default", "none", "error"]
    ) -> list[float | None]:
    ...
    def prefix(self, prefix: str):
        ...
        prefixed_joint_names = [
            "".join(self.prefixes) + name for name in self.unprefixed_joint_names
        ]
