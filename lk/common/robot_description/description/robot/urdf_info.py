...
class UrdfInfo:
    ...
    def get_xml_body(
        self, config_file_path: str, resolve_packages: bool = False
    ) -> str:
        ...
        try:
            return xml_body_from_macro_xml(
                macro_xml=self.get_macro_xml(config_file_path),
                imports=self.xacro_imports,
    ...
    def get_xml(
        ...
        if self.path:
            ...
            return self.get_combined_xml(
                self.get_xml_body(config_file_path, resolve_packages=resolve_packages)
            )
