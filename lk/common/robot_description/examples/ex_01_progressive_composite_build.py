...
def generate_robot_description() -> RobotDescription:
    ...
    front_left_artist = RobotArtist.from_robot_description(front_left).block_till_input()
    ...
    rack = RobotDescription.combine(
        ...
        robot_info=RobotInfo(name="quad_arm_rack", type="rack", sku="v1", version="0.0.1")
    )
    ...
    facility = RobotDescription.combine(
        ...
        robot_info=RobotInfo(name="mrf_facility", type="facility", sku="v1", version="0.0.1")
    )
