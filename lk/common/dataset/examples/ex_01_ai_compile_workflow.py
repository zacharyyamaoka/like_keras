...
def record_original_implementation(component: VectorNormalizer, 
                                  inputs: list[Vec3]) -> Dataset:
    """
...
def create_compilation_prompt(component: VectorNormalizer, 
...
def record_new_implementation(inputs: list[Vec3], 
...
def compare_implementations(dataset_original: Dataset, 
                          dataset_new: Dataset,
...
def demonstrate_playback(dataset: Dataset) -> None:
    ...
    for i in range(min(5, len(dataset))):
        ...
        print(f"    Output: ({output_vec.x:.3f}, {output_vec.y:.3f}, {output_vec.z:.3f})")
